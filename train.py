...
def get_args():
    ...
    parser.add_argument("--output_path", type=str, default="checkpoints",
                        help="checkpoint dir")
    parser.add_argument("--source_noise_model", type=str, default="gaussian,0,50,0",
                        help="noise model for source images")
    parser.add_argument("--target_noise_model", type=str, default="gaussian,0,50,0",
                        help="noise model for target images")
    parser.add_argument("--val_noise_model", type=str, default="gaussian,25,25,0",
...
def main():
    ...
    hist = model.fit_generator(generator=generator,
                               steps_per_epoch=steps, ## ORIGINAL
                               # https://stackoverflow.com/questions/59864408/tensorflowyour-input-ran-out-of-data
                               # CHANGE: steps_per_epoch = len(X_train)//batch_size
                               #steps_per_epoch=291//batch_size,
                               # CHANGE: validation_steps = len(X_test)//batch_size # if you have test data
